...
public class Vehicle {
    ...
    public Vehicle(int stockNumber, int año, String marca, String modelo, String stilo, String vin, String colorExterior, String colorInterior, String miles, float precio, Transmission transmision, String motor, String imagen, String estado) {
    ...
    public String getStilo() {
        return stilo;
    }

    public void setStilo(String stilo) {
        this.stilo = stilo;
    }
